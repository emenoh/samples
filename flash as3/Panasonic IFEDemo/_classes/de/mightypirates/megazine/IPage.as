...
package de.mightypirates.megazine {
	...
	/**
	 * Interface for the Page class, to be used in elements. Especially for
	 * external objects, to reduce file size (by only importing the interface
	 * and not the actual class with all the code).
	 * 
	 * @author fnuecke
	 * @version 1.0
	 */
