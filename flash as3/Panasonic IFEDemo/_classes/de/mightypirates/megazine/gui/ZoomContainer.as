...
package de.mightypirates.megazine.gui {
	...
	public class ZoomContainer extends Sprite {
		...
		private function onError(e:IOErrorEvent):void {
			Logger.log("MegaZine Zoom", "Error loading highres image from path '"
										+ Helper.trimString(e.target.url, 40)
		...
		private function onLoaded(e:Event):void {
			_imageLoader.contentLoaderInfo.removeEventListener(ProgressEvent.PROGRESS,
															   onProgress);
