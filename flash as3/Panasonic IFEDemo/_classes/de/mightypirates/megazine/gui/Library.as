...
package de.mightypirates.megazine.gui {
	...
	/**
	 * This class acts as an interface to SWF files which have a function of the following
	 * type in their root:
	 * funtion getInstanceOf(String):DisplayObject
	 * It can be used to load graphics from said SWF files.
	 * @author fnuecke
	 * @version 1.0
	 */
	public class Library extends EventDispatcher implements ILibrary {
		...
		private static const VERSION:Number = 1.031;
