...
package de.mightypirates.megazine.gui {
	...
	public class LangChooser extends Sprite {
		...
		/** Base image with all flags */
		[Embed(source="LangChooser_Flags.gif")]
		private static var Flags:Class;
		...
		private static function initFlags():void {
			if (flags != null) return;
			flags = new Dictionary();
			var flagImgs:Bitmap = new Flags();
			...
			var langs:Array = ["de", "en", "es", "fr", "it", "ja", "ru", "th", "zh"];
		 ...
		 */
		public function LangChooser(loc:Localizer, lib:Library) {
