...
package de.mightypirates.megazine.gui {
	...
	public class Navigation extends Sprite {
		...
		public function Navigation(pages:uint, width:Number, thumbWidth:uint, thumbHeight:uint,
								   buttonShow:Array, pageNumbers:Boolean, navigation:Boolean,
								   currentPage:uint, mz:MegaZine, loc:Localizer, lib:Library)
		{
			...
			if (navigation) {
				...
				_pageThumb.y = -thumbHeight - THUMB_BORDER * 2 - 50 ;
