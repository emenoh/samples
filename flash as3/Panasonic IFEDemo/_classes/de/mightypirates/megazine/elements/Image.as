	...
	public class Image extends AbstractElement {
		...
		private function onImageLoad(e:Event):void {
			...
			try {
				...
				var titleLangs:XMLList = _xml.elements("title");
				if (url != "") {
					...
					if (Helper.validateBoolean(_xml.@useglow, true)) {
						...
						var t:Timer = new Timer(750 / stage.frameRate);
