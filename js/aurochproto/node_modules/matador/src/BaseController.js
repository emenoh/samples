...
module.exports = function (app) {
  ...
  return klass(function () {
    ...
    , error: function (res) {
      ...
      // NOTE: Adding support for returning partials via Express to return html snippets for ajax
      // data can be any html snippet
    , snippet: function(res, file, headers, status){
      fs.readFile(app.set('base_dir')+'/models/fixtures/MiniCart.html', function (err, data) {
        if (err) throw err;
        body = data.toString()
        try {
        ...
        res.send(body, headers, status)
            ...
            console.error('Partial error, body:', body, 'error:', e.message, e.stack)
            throw e
        }
      });
