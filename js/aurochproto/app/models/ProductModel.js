module.exports = function (app, config) {
  ...
  .methods({
  	getProductByPartNumber: function(pid,store, gender){

  		var module = this
  		var serviceURL = 'http://www.fossil.com/webapp/wcs/stores/servlet/FSAJAXService?service=getProductByPartNumber&langId=-1&storeId='+store+'&catalogId=25005&partNumber='+pid
  		var data = ''
